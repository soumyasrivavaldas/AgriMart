...
#router.register('updateProduct',views.UpdateData),

router = routers.DefaultRouter()
router.register('addproducts',views.AddProductsView)
...
urlpatterns = [
    ...
    path('cus_orders/',views.OrderPlacedApiCustomer.as_view()),
    path('reci_orders/',views.OrderPlacedApiFarmer.as_view()),
